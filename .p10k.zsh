...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                 # \n
    custom_dir              # current directory name only
    vcs                     # git status
...
'builtin' 'unset' 'p10k_config_opts'
  ...
  # Custom directory name segment
  typeset -g POWERLEVEL9K_CUSTOM_DIR_SHOW_ON_COMMAND=''
  function prompt_custom_dir() {
    p10k segment -f 39 -i '' -t "${PWD##*/}"
  }
}
